...
//  #  define GLUTCALLBACK
// informational EDC3378: "GLUTCALLBACK" is defined on line 26 of "G:\EVGEN\MESA5\GL\os2_x11.h".
  #  define GLUTAPI  /* extern */
  #  define WGLAPI
...
extern GLUTAPI void *glutStrokeRoman;
extern GLUTAPI void *glutStrokeMonoRoman;
...
/* EK - бред собачий ! это указатели типа BitmapFontPtr */
/*
...
#if __OS2__
void APIENTRY glutCommandFunc(void (* GLUTCALLBACK GLUTcommandCB) (HWND hwnd,  MPARAM mp1, MPARAM mp2 ) );
#endif
