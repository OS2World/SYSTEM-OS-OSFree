...
/* EK
   ...
   1 for origin in bottom left conner (OS2-like)
*/
#define gdNORMALIMAGEORIGIN 1
...
/*
 flCmd
     ...
     Some of the DT_ flags are mutually exclusive. Only one from each of these groups is significant:
         gdDT_LEFT (default), gdDT_CENTER, gdDT_RIGHT
         gdDT_TOP (default), gdDT_VCENTER, gdDT_BOTTOM.
*/
#define  gdDT_LEFT     0x01   /*  Left-justify the text.  */
#define  gdDT_CENTER   0x02   /*  Center the text.        */
#define  gdDT_RIGHT    0x04   /*  Right-justify the text. */
#define  gdDT_VCENTER  0x08   /*  Vertically center the text. */
#define  gdDT_TOP      0x10   /*  Top-justify the text.   */
#define  gdDT_BOTTOM   0x20   /*  Bottom-justify the text. */

void gdImageDrawText(gdImagePtr im, gdFontPtr f, int x, int y, unsigned char *s, int color, int flCmd );
void gdImageDrawTextUp(gdImagePtr im, gdFontPtr f, int x, int y, unsigned char *s, int color, int flCmd );
