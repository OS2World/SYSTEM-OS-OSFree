...
extern GBM_ERR pbm_rdata(int fd, GBM *gbm, gbm_u8 *data);
extern GBM_ERR pbm_w(const char *fn, int fd, const GBM *gbm, const GBMRGB *gbmrgb, const gbm_u8 *data, const char *opt);
