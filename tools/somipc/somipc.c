...
my_input_cb (IDL_input_reason reason, union IDL_input_data *cb_data, gpointer user_data)
{
        ...
        case IDL_INPUT_REASON_FINISH:
                ...
                printf ("my_input_cb: abort or finish");
                fclose (my_data->in);
                break;
        }
...
main (int argc, char *argv[])
{
        ...
        printf ("libIDL version %s", IDL_get_libver_string ());
        ...
        printf ("IDL_parse_filename_with_input");
