/* ATTRIB command replaced by osFree team implementation
...
static int _attrib( ATTRIB_STRUCT *Attrib )
{
        ...
        if ( Attrib->fFlags & ATTRIB_SUBDIRS ) {
                ...
                //   return subdir names
                for ( fval = FIND_FIRST; ( find_file( fval, Attrib->szSource, ( Attrib->nMode | 0x310 ),&dir,NULL ) != NULL ); fval = FIND_NEXT) {
