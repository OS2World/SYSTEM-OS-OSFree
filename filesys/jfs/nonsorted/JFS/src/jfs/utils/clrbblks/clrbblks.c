/* $Id: clrbblks.c,v 1.1.1.1 2003/05/21 13:41:10 pasha Exp $ */
 ...
 *
 */
int32 get_LVM_BadBlockLists( void );
 ...
 */
int32 clrbblks( int32  argc,  char  **argv )
{
    int32		rc;
    int		finished = 0;
    int32		pList;
    ...
    init_agg_record();		/* need this before calling preamble() */
