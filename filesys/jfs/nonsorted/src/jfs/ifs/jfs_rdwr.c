/* $Id: jfs_rdwr.c,v 1.1 2000/04/21 10:58:15 ktk Exp $ */
...
// BEGIN F226941
        ...
        if ((TlocksLow && ip->i_atlhead) || (ip->i_flag & ISYNCLIST) ||
          ...
          int64 nbytes)
{
         ...
         * synchronously.
         */
        if ((ip->i_flag & IUPDNEW) == 0)                        // F226941
                rc = cmWrite(ip->i_cacheid, firstb, lastb - firstb + 1);
