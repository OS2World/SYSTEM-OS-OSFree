...
int far pascal FS_ATTACH(
    ...
    char far * pDev,		/* pDev		*/
    void far * pvpfsd,		/* if remote drive struct vpfsd far * else if remote device null ptr (0L)    */
    void far * pdevfsd,		/* if remote drive struct cdfsd far * else struct devfsd far * */
